...
int main(int argc, char** argv) {
    ...
    if (params.data.ncorr > 6) {
        // c++ 6  || r 7
        file_head.k[2] = mu1;    file_head.k[3] = mu1;
        double* E2_0_pxmpx_pympy = plateau_correlator_function(option, kinematic_2pt, (char*)"P5P5", conf_jack, Njack, namefile_plateaux, outfile, 6, "E2_0_pxmpx_pympy", shift_and_M_eff_sinh_T, jack_file);
        free(E2_0_pxmpx_pympy);

        // c++ 7  || r 8
        file_head.k[2] = mu1;    file_head.k[3] = mu1;
        double* E2_0_pympy_pzmpz = plateau_correlator_function(option, kinematic_2pt, (char*)"P5P5", conf_jack, Njack, namefile_plateaux, outfile, 7, "E2_0_pympy_pzmpz", shift_and_M_eff_sinh_T, jack_file);
        free(E2_0_pympy_pzmpz);

        // c++ 8  || r 9
        file_head.k[2] = mu1;    file_head.k[3] = mu1;
        double* E2_0_pzmpz_pxmpx = plateau_correlator_function(option, kinematic_2pt, (char*)"P5P5", conf_jack, Njack, namefile_plateaux, outfile, 8, "E2_0_pzmpz_pxmpx", shift_and_M_eff_sinh_T, jack_file);
        free(E2_0_pzmpz_pxmpx);




    }
    else { for (int i = 6;i < 9;i++)  fwrite(zeros, sizeof(double), Njack, jack_file); }

    if (params.data.ncorr >= 9) {
        double* tmp;
        tmp = plateau_correlator_function(option, kinematic_2pt, (char*)"P5P5", conf_jack, Njack, namefile_plateaux, outfile, 9, "E1_0_imag", identity, jack_file);
        free(tmp);
        tmp = plateau_correlator_function(option, kinematic_2pt, (char*)"P5P5", conf_jack, Njack, namefile_plateaux, outfile, 10, "E1_1_imag", identity, jack_file);
        free(tmp);
        tmp = plateau_correlator_function(option, kinematic_2pt, (char*)"P5P5", conf_jack, Njack, namefile_plateaux, outfile, 11, "E2_0_imag", identity, jack_file);
        free(tmp);
        tmp = plateau_correlator_function(option, kinematic_2pt, (char*)"P5P5", conf_jack, Njack, namefile_plateaux, outfile, 12, "E2_1_imag", identity, jack_file);
        free(tmp);
        tmp = plateau_correlator_function(option, kinematic_2pt, (char*)"P5P5", conf_jack, Njack, namefile_plateaux, outfile, 13, "E3_0_imag", identity, jack_file);
        free(tmp);
        tmp = plateau_correlator_function(option, kinematic_2pt, (char*)"P5P5", conf_jack, Njack, namefile_plateaux, outfile, 14, "E3_1_imag", identity, jack_file);
        free(tmp);


    }
    else { for (int i = 9;i <= 14;i++)  fwrite(zeros, sizeof(double), Njack, jack_file); }
