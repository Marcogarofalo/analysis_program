...
int main(int argc, char **argv){
     ...
     */
     ...
     //0
     mysprintf(namefile,NAMESIZE,"%s/%s_G2t_T64_L24_msq0-4.900000_msq1-4.650000_l02.500000_l12.500000_mu5.000000_g0.100000_rep0",argv[2],argv[1]);
     emplace_back_par_data(namefile,paramsj,dataj);
     //1
     mysprintf(namefile,NAMESIZE,"%s/%s_G2t_T64_L26_msq0-4.900000_msq1-4.650000_l02.500000_l12.500000_mu5.000000_g0.100000_rep0",argv[2],argv[1]);
     emplace_back_par_data(namefile,paramsj,dataj);
     //2
     mysprintf(namefile,NAMESIZE,"%s/%s_G2t_T64_L28_msq0-4.900000_msq1-4.650000_l02.500000_l12.500000_mu5.000000_g0.100000_rep0",argv[2],argv[1]);
     emplace_back_par_data(namefile,paramsj,dataj);
     //3
     mysprintf(namefile,NAMESIZE,"%s/%s_G2t_T64_L30_msq0-4.900000_msq1-4.650000_l02.500000_l12.500000_mu5.000000_g0.100000_rep0",argv[2],argv[1]);
     emplace_back_par_data(namefile,paramsj,dataj);
     
     //4
     mysprintf(namefile,NAMESIZE,"%s/%s_G2t_T64_L32_msq0-4.900000_msq1-4.650000_l02.500000_l12.500000_mu5.000000_g0.100000_rep0",argv[2],argv[1]);
     emplace_back_par_data(namefile,paramsj,dataj);
     
     mysprintf(namefile,NAMESIZE,"%s/%s_G2t_T64_L34_msq0-4.900000_msq1-4.650000_l02.500000_l12.500000_mu5.000000_g0.100000_rep0",argv[2],argv[1]);
     emplace_back_par_data(namefile,paramsj,dataj);
     
     mysprintf(namefile,NAMESIZE,"%s/%s_G2t_T64_L36_msq0-4.900000_msq1-4.650000_l02.500000_l12.500000_mu5.000000_g0.100000_rep0",argv[2],argv[1]);
     emplace_back_par_data(namefile,paramsj,dataj);
     
     mysprintf(namefile,NAMESIZE,"%s/%s_G2t_T64_L40_msq0-4.900000_msq1-4.650000_l02.500000_l12.500000_mu5.000000_g0.100000_rep0",argv[2],argv[1]);
     emplace_back_par_data(namefile,paramsj,dataj);
...
//     }
//        zeta.write("zeta_g0.1.dat");
       zeta.read("zeta_g0.1.dat");
...
//      zeta_qsqg.Init(  );
     ...
     fit_info.Nvar=13;                   fit_info_m0.Nvar=13;            
