...
int main(int argc, char** argv) {
    ...
    // mysprintf(namefile, NAMESIZE, "%s/%s_G2t_T64_L20_msq0-1.204000_msq1-0.370000_l00.000000_l10.000000_mu0.000000_g20.000000_rep0", argv[2], argv[1]);
    // emplace_back_par_data(namefile, paramsj, dataj);
    // files.emplace_back(namefile);
    mysprintf(namefile, NAMESIZE, "%s/%s_G2t_T64_L21_msq0-1.204000_msq1-0.370000_l00.000000_l10.000000_mu0.000000_g20.000000_rep0", argv[2], argv[1]);
    emplace_back_par_data(namefile, paramsj, dataj);
    files.emplace_back(namefile);

    mysprintf(namefile, NAMESIZE, "%s/%s_G2t_T64_L22_msq0-1.204000_msq1-0.370000_l00.000000_l10.000000_mu0.000000_g20.000000_rep0", argv[2], argv[1]);
    emplace_back_par_data(namefile, paramsj, dataj);
    files.emplace_back(namefile);
    mysprintf(namefile, NAMESIZE, "%s/%s_G2t_T64_L23_msq0-1.204000_msq1-0.370000_l00.000000_l10.000000_mu0.000000_g20.000000_rep0", argv[2], argv[1]);
    emplace_back_par_data(namefile, paramsj, dataj);
    files.emplace_back(namefile);
    mysprintf(namefile, NAMESIZE, "%s/%s_G2t_T64_L24_msq0-1.204000_msq1-0.370000_l00.000000_l10.000000_mu0.000000_g20.000000_rep0", argv[2], argv[1]);
    emplace_back_par_data(namefile, paramsj, dataj);
    files.emplace_back(namefile);
    mysprintf(namefile, NAMESIZE, "%s/%s_G2t_T64_L25_msq0-1.204000_msq1-0.370000_l00.000000_l10.000000_mu0.000000_g20.000000_rep0", argv[2], argv[1]);
    emplace_back_par_data(namefile, paramsj, dataj);
    files.emplace_back(namefile);
    mysprintf(namefile, NAMESIZE, "%s/%s_G2t_T64_L26_msq0-1.204000_msq1-0.370000_l00.000000_l10.000000_mu0.000000_g20.000000_rep0", argv[2], argv[1]);
    emplace_back_par_data(namefile, paramsj, dataj);
    files.emplace_back(namefile);

    mysprintf(namefile, NAMESIZE, "%s/%s_G2t_T64_L27_msq0-1.204000_msq1-0.370000_l00.000000_l10.000000_mu0.000000_g20.000000_rep0", argv[2], argv[1]);
    emplace_back_par_data(namefile, paramsj, dataj);
    files.emplace_back(namefile);
    ...
    // zeta.write("zeta_complex_g20.dat");
    zeta.read("zeta_complex_g20.dat");
    ///////////////////////////////////////////////////////////////////////////////////////////////////
    // printing files
    //////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    printf("//////////////////// kcot 1par and kiso pole 4par fit   ////////////////////////////////////\n");
    // init_python_detQC();
    init_python_detQC_kcot_kiso("kcot_1par", "kiso_pole", "find_2sol_QC3_pole");
    ...
    fit_info.guess = { 204.692, 9.12076, 2491.55, 0.001, -0.149458 };
    fit_info.Prange = { 1, 0.01, 20, 0.001 ,0.1 };


    fit_info.compute_cov1_fit();
    mysprintf(namefile, NAMESIZE, "kcot_1par_1lev_and_kiso_pole_4par", fit_info.Npar);
    ...
    printf("//////////////////// kcot 1par and kiso pole  3par fit cov  ////////////////////////////////////\n");
    // init_python_detQC();
    init_python_detQC_kcot_kiso("kcot_1par", "kiso_pole", "find_2sol_QC3_pole");
    ...
    fit_info.compute_cov1_fit();
    fit_info.guess = { 210.144, 9.12076,  2243.41,  -0.148414 };
    ...
    fit_info.compute_cov1_fit();
    fit_info.noderiv = true;
    fit_info.Prange = { 5,0.001, 0.1 };


    mysprintf(namefile, NAMESIZE, "kcot_1par_1lev_and_kiso_const_cov", fit_info.Npar);
    // struct fit_result kcot_1lev_and_kiso_pole_3par_cov = fit_all_data(argv, jackall, lhs_E3_E1_E2_m_complex_new, fit_info, namefile);
    // fit_info.band_range = { 5.65,7.2 };
    // print_fit_band(argv, jackall, fit_info, fit_info, namefile, "L_m", kcot_1lev_and_kiso_pole_3par_cov, kcot_1lev_and_kiso_pole_3par_cov, 0, myen.size() - 1, 0.15);
    fit_info.restore_default();
