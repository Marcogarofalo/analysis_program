...
int main(int argc, char **argv){
    ...
    //0
    mysprintf(namefile,NAMESIZE,"%s/%s_G2t_T32_L28_msq0-4.900000_msq1-4.650000_l02.500000_l12.500000_mu5.000000_g0.025000_rep0",argv[2],argv[1]);
    emplace_back_par_data(namefile,paramsj,dataj);
    mysprintf(namefile,NAMESIZE,"%s/%s_G2t_T32_L30_msq0-4.900000_msq1-4.650000_l02.500000_l12.500000_mu5.000000_g0.025000_rep0",argv[2],argv[1]);
    emplace_back_par_data(namefile,paramsj,dataj);
...
*/
    ...
    if (myen.size()==1){
        fit_info.Npar=1;                   fit_info_m0.Npar=1;           
    }
    else  {
...
*/
    ...
    int Nxlevel=1    ;
    fit_info_E3_poly.Npar=fit_info_E3_poly.N*Nxlevel;
    if (Nxlevel==1)
        fit_info_E3_poly.function=rhs_const_E3_m;
    else if(Nxlevel==2)
        fit_info_E3_poly.function=rhs_poly2_E3_m;
    else 
