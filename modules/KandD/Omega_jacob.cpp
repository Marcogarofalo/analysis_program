...
double ***data_omega(char *option, int Njack  , struct header *head){
   ...
   if (ensemble_omega_jacob>6){
            //B072
       int e=6;
       mean[e][0]=0.551461668595345; mean[e][1]= 7.77288559308582;
   ...
   for (int e=0;e<ensemble_omega_jacob;e++){
       //power up the errors
       cov[e][0][0]*=2; cov[e][0][1]*=2; cov[e][1][1]*=2;
       //make the matrix symmetric
       cov[e][1][0]=cov[e][0][1];
       double  **P=fake_sampling_covariance(option,  mean[e],  Njack, 2 ,cov[e], e);
       double *Pw=fake_sampling(option,w0[e][0],w0[2][1],Njack,e+ensemble_omega_jacob);
