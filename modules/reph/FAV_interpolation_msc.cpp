 #define FAV_interpolation_msc_C
...
double inter_4(double xs1, double xs2,double xc1, double xc2 , double ys1c1, double ys2c1, double ys1c2, double ys2c2, double xs, double xc){
    ...
    m1=( ys1c1-ys2c1 )/(   xs1  -  xs2   );
    b1=ys1c1-m1*xs1;
    
    m2=( ys1c2-ys2c2 )/(   xs1  -  xs2   );
    b2=ys1c2-m2*xs1;
...
static void init_fit( int N, struct header *head ,int Njack, struct reph_jack *gJ,int Npar, double xg_min,struct ik_for_n *ik_comb, int **en,int *en_tot, double ***x, double **chi2m, double **rm, double ***r, double ***fit, double ****y,double **chi2,double ****C)
{
